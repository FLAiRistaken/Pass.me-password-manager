...
"color: rgba(255, 255, 255, 200);")
        ...
        QWidget.setTabOrder(self.le_name, self.le_acc_name)
        QWidget.setTabOrder(self.le_acc_name, self.le_account_number)
        QWidget.setTabOrder(self.le_account_number, self.le_sortcode)
