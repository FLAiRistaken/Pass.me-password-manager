...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(524, 724)
        Form.setMinimumSize(QSize(524, 724))
        Form.setMaximumSize(QSize(524, 724))
...
"")
        ...
        self.lbl_new_login = QLabel(self.widget)
        self.lbl_new_login.setObjectName(u"lbl_new_login")
        sizePolicy2 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.lbl_new_login.sizePolicy().hasHeightForWidth())
        self.lbl_new_login.setSizePolicy(sizePolicy2)
        self.lbl_new_login.setMaximumSize(QSize(364, 112))
        font1 = QFont()
        font1.setFamilies([u"Nexa-Trial"])
        font1.setPointSize(31)
        self.lbl_new_login.setFont(font1)
        self.lbl_new_login.setStyleSheet(u"color: rgba(255,255,255, 220);")
        self.lbl_new_login.setTextFormat(Qt.RichText)

        self.gridLayout_2.addWidget(self.lbl_new_login, 2, 0, 1, 2, Qt.AlignLeft)
...
"color: rgba(255, 255, 255, 200);")
    ...
    def retranslateUi(self, Form):
        ...
        self.lbl_new_login.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-weight:700;\">New Login</span></p></body></html>", None))
